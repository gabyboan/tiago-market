    ...
    products: [
      {
        ...
        storeEnabled: false,
        source: "mock",
        sourceProductName: `${productMeta.internalName} Marca Ejemplo`,
        sourceStoreName: "Mock Market",
        sourceBranchName: "Sucursal demo",
        sourceBranchKey: "mock-market-sucursal-demo",
        sourceAddress: null,
        ...
        sourceCityCode: null,
        sourceCityName: null,
        externalReference: `https://example.com/productos/${slug}`,
        rawPayload: {
          generator: "mock",
          searchTerm,
        ...
        storeProductUrl: `https://example.com/productos/${slug}`,
